            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <section class="panel">
                  ...
                  <div class="panel-body">
                    <div class="form">
                        {!! Session::get('msg') !!} 
                        {!! Form::open(['url' => route('admin.save.email'), 'class' => 'form-validate form-horizontal', 'id' => 'form_resource',  'onsubmit' => '']) !!}
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-6 col-md-4 col-sm-4">
                                    <textarea class="form-control" name="alertFromCandidate" id="alertFromCandidate"></textarea>
                                  </div>
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-lg-6 col-md-4 col-sm-4">
                                      <textarea class="form-control" name="alertFromTrainer" id="alertFromTrainer"></textarea>
                                  </div>
                                  <div class="col-lg-4 col-md-4 col-sm-4 padtop">
