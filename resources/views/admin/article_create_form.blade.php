                        ...
                        {!! Form::open(['url' => route('admin.article.insert'), 'class' => 'form-validate form-horizontal', 'id' => 'form_article',  'onsubmit' => 'return isValidate_form_article()']) !!}
                          ...
                          @endif
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-4 col-sm-4">
                                        {!! Form::select('articleBanner', $ctrl_image_slide, '', ['class' => 'form-control chosen-select', 'id' => 'articleBanner', 'data-placeholder' => 'Choose a banner image']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="articleAdditional" class="control-label col-lg-2 col-md-4 col-sm-4"> Additional Content</label>
                                    <div class="col-lg-6 col-md-4 col-sm-4">
                                        {!! Form::select('articleAddition', $ctrl_additional, '', ['class' => 'form-control chosen-select', 'id' => 'articleAdditional', 'data-placeholder' => 'Choose a Additional Content']) !!}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="articleGalllery" class="control-label col-lg-2 col-md-4 col-sm-4">Gallery </label>
                                    <div class="col-lg-6 col-md-4 col-sm-4">
                                      {!! Form::select('articleGallery', AdminHelper::controlGallery(), null, ['class' => 'form-control chosen-select', 'id' => 'articleGallery', 'data-placeholder'=>'Choose a Gallery']) !!}
                                    </div>
                                </div>
                          {{--
                                      <div class="form-group">
