                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                            {!! Form::open(['url' => route('admin.resourcetype.search'), 'class' => 'navbar-form', 'id' => 'find_resource_type']) !!}
                              {!! Form::text('search', null, ['class' => 'form-control', 'placeholder' => 'Search', 'id' => 'key_word']) !!}
                            {!! Form::close() !!}
                            <div class="pull-right">
                              <button class="btn btn-primary" id="new-button">New Resource type</button>
                            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure? The Resource Type "<span></span>", you will remove from resource type list.</p>
      </div>
...
@section('script')
<script type="text/javascript" src="{{ URL::asset('public/backend/js/component/scripts-resource-type.js') }}"></script>
@endsection